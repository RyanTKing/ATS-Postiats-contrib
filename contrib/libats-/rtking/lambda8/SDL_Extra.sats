...
**
** SDL_Extra.sats: Additional SDL functionality
*)

%{#
#include "SDL_Extra.cats"
%}

#define ATS_PACKNAME      "SDL_EXTRA"
...
typedef SDL_Keycode = uint

(* SDL Keysym *)
typedef SDL_Keysym = $extype_struct"SDL_Keysym" of {
...
fun SDL_Keycode_eq(sym1: SDL_Keycode, sym2: SDL_Keycode): bool = "mac#%"

fun GetKeysym(event: !SDL_Event): SDL_Keycode = "mac#%"

(* SDL KeyBoard Event *)
typedef SDL_KeyboardEvent = $extype_struct"SDL_KeyboardEvent" of {
  type = uint,
  timestamp = uint,
  windowID = uint,
  state = uchar,
...
castfn SDL_KeyboardEvent_of_Event(SDL_Event):<> SDL_KeyboardEvent
